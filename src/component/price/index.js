...
class Price extends React.Component {
  formatValue = (value, precision, keepZero, divRatio) => {
  ...
  render () {
    ...
    return (
      <span {...rest}>
        ...
        }}>{_currency}</span>{this.addComma(useGrouping, this.formatValue(value, precision, keepZero, divRatio))}
      </span>
    )
  }
}
