...
"use strict";function r(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0});var o=n(6),a=r(o),l=n(2),i=r(l),u=n(22),s=r(u),c={error:"gm-invalid"},p=["onChange","onBlur","onFocus"],f=function e(t,n){if(n.props&&void 0!==n.props.name){var r;i.default.find(p,function(e){if(n.props[e])return r=n.props[e].___validate_rule,!0}),r&&t.push({name:n.props.name,rule:r})}else n.props&&n.props.children&&i.default.isArray(n.props.children)?i.default.each(n.props.children,function(n){e(t,n)}):n.props&&n.props.children&&i.default.isObject(n.props.children)&&e(t,n.props.children)},d=function(e){var t=[];return f(t,e),t},h=function(e,t,n){var r=n.value,o=n.name,a=(0,s.default)(t,r,!0);e.tip[o]=a,a===!0?n.className=i.default.without(n.className.split(" "),c.error).join(" "):n.className=i.default.union(n.className.split(" "),[c.error]).join(" ")},m=function(){var e={tip:{}};return{validate:function(t,n){var r=this,o=function(o){h(e,t,o.target),r.setState({}),n&&n.apply(r,arguments,e.tip[o.target.name])};return o.___validate_rule=t,o},validateAll:function(t){if(!t)return!1;var n=this,r=d(t),o=a.default.findDOMNode(t);return i.default.each(r,function(t){h(e,t.rule,o[t.name])}),n.setState({}),0===n.validateTip().length},validateTip:function(t){return t?e.tip[t]:i.default.map(i.default.filter(e.tip,function(e){return e!==!0}),function(e){return e})}}};t.default=m},function(e,t){}])});