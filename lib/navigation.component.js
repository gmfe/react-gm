                ...
                <ul>
                    {_.map(data, value => (
                        <li key={value.key}
                            ...
                            <Flex alignCenter className="gm-navigation-title">
                                <Flex flex onClick={this.handleClick.bind(this, value)}>{value.title}</Flex>
                                {value.sub && (
                                    <span
                                        className={"fa gm-navigation-icon " + (value.open ? 'fa-angle-up' : ' fa-angle-down')}></span>
                                )}
                            </Flex>
                            {value.sub && (
                                    ...
                                    <ul className="gm-navigation-cell gm-navigation-level2">
                                        {_.map(value.sub, val => (
                                            <li key={val.key}
                                                ...
                                                <div className="gm-navigation-title"
