...
var Calendar = React.createClass({
    ...
    getInitialState: function () {
        return {
            ...
            moment: moment(this.props.selected), // 日历内的时间
            isSelectMonth: false,
        ...
        return (
            <div className="gm-calendar-head text-center clearfix">
                <a href="javascript:;" className="gm-calendar-head-pre pull-left"
                   onClick={this.handleChangeMonth.bind(this, month - 1)}><i className="fa fa-caret-left fa-lg"></i></a>
                ...
                <a href="javascript:;" className="gm-calendar-head-next pull-right"
                   onClick={this.handleChangeMonth.bind(this, month + 1)}><i
                    className="fa fa-caret-right fa-lg"></i></a>
            </div>
        );
    },
    renderWeek: function () {
