...
var GridHead = React.createClass({
    render: function () {
        ...
        return (
            ...
            <tr>
                {data.enableSelect ? (
                    <th className="gm-grid-select"><input type="checkbox" onClick={this._onSelect.bind(this)}/>
                    </th>) : ''}
        ...
        return (
            <div className="gm-grid">
                <table className="table table-striped table-hover table-condensed table-bordered">
                    <GridHead data={data} onSelect={t._onSelectAll.bind(t)}></GridHead>
                    <tbody>
                    {tableBody}
                    </tbody>
                </table>
                <div className="gm-grid-foot clearfix">
                    ...
                    <div className="pull-right">
                        <Pagination data={data.pagination} toPage={t._onToPage.bind(this)}></Pagination>
                    </div>
                    <div className="pull-right">
