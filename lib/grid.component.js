...
var GridHead = React.createClass({
    render: function () {
        ...
        var isSelectAll = _.filter(data.list, function (value) {
        ...
        return (
            ...
            <tr>
                {data.enableSelect ? (
                    <th className="gm-grid-select"><input type="checkbox" defaultChecked={isSelectAll} onClick={this.onSelect}/>
                    </th>) : undefined}
        ...
        if (data.loading) {
            ...
            tableBody = data.list.map(function (elist, index) {
                ...
                return (
                    <tr key={index}>
                        {data.enableSelect ? (
                            <td><input type="checkbox" checked={elist._gm_select} onClick={t.onSelect.bind(t, index)}/>
                            </td>) : undefined}
                        {tds}
