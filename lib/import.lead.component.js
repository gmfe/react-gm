...
import Droper from './droper.component';
            ...
            var tds = data.columns.map(function (col, i) {
                ...
                return tip ? (
                    <td key={i} className={tip.modifyed ? "gm-bg-info" : "gm-bg-invalid"}>
                        <input disabled={t.props.disableEdit} type="text" value={elist[col.field]}
            ...
            <div className="gm-import-lead">
                <div>
                    <div>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <button disabled={!canSubmit} className="btn btn-primary btn-sm" onClick={this.handleSubmit}>
                            提交
                        </button>
                        &nbsp;&nbsp;&nbsp;&nbsp;
