        ...
        return (
            <div className="gm-pagination">
                <ul className="pagination pagination-sm" onClick={this.onPage}>
                    ...
                    { begin >= 2 ? (<li><a href="javascript:;" data-page="1">1</a></li>) : null}
                    { begin >= 3 ? (<li className="disabled"><a href="javascript:;">...</a></li>) : null}

                    {pages.map((page, i) => <li key={i} className={data.index === page ? 'active' : ''}><a
                        href="javascript:;" data-page={page}>{page}</a></li>)}

                    { end <= all - 2 ? (<li className="disabled"><a href="javascript:;">...</a></li>) : null}
                    { end <= all - 1 ? (<li><a href="javascript:;" data-page={all}>{all}</a></li>) : null}
